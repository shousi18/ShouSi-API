...
import com.shousi.shousicommon.model.dto.userinterfaceinfo.UserInterfaceInfoAddRequest;
import com.shousi.shousicommon.model.dto.userinterfaceinfo.UserInterfaceInfoQueryRequest;
import com.shousi.shousicommon.model.dto.userinterfaceinfo.UserInterfaceInfoUpdateRequest;
...
public class UserInterfaceInfoController {
     ...
     * 创建
     *
     * @param userInterfaceInfoAddRequest 添加参数
     * @param request 请求
     * @return 新增id
     */
    @PostMapping("/add")
     ...
     * 更新
     *
     * @param userInterfaceInfoUpdateRequest 更新参数
     * @param request 请求
     * @return 是否更新成功
     */
    @PostMapping("/update")
     ...
     * 获取列表（仅管理员可使用）
     *
     * @param userInterfaceInfoQueryRequest 查询参数
     * @return 接口列表
     */
    @GetMapping("/list")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
